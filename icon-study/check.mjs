...
for (const name of ['01-simplified-flame.png', '02-constructed-flame.png', '03-framed-flame.png', '04-solid-capture.png', '05-green-window.png', '06-unified-flame.png', '07-combined-flame.png', '08-airy-frame.png', '09-bold-frame.png']) {
...
assert.ok(html.includes('<details id="round-3" open>'), 'Round three is visible by default');
...
console.log('Three rounds, native round controls, nine icon assets, and all seven sizes checked.');
